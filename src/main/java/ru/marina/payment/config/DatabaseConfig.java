package ru.marina.payment.config;
...
import ru.marina.payment.creditcard.CreditCard;
...
public class DatabaseConfig {
    ...
    public ConversionService conversionService() {
        ...
        converter.addConverter(new Converter<String, YearMonth>() {
            @Override
    ...
    @Bean
    public BeanPropertyRowMapper<CreditCard> beanPropertyRowMapper(final ConversionService conversionService) {
        final BeanPropertyRowMapper<CreditCard> rowMapper = BeanPropertyRowMapper.newInstance(CreditCard.class);
