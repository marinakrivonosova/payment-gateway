...
public class ProcessPaymentRequest {
    ...
    public ProcessPaymentRequest(final String cardNumber, final String cvc, final YearMonth expirationDate, final String cardHolder, final BigDecimal chargedAmount) {
